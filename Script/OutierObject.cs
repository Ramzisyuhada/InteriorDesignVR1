...
public class OutierObject : MonoBehaviour
{
    ...
    private void HandleRaycastHit(RaycastHit hit)
    {
        ...
        if ((highlight.CompareTag("Surface") || highlight.CompareTag("Decoration") || highlight.CompareTag("Wall") || highlight.CompareTag("Wall Decoration") || highlight.CompareTag("Furniture") || highlight.CompareTag("Door") || highlight.CompareTag("Ceiling") || highlight.CompareTag("Pertanyaan")) && highlight  != selection)
        {
            Outline outline = highlight.gameObject.GetComponent<Outline>();
            if (outline == null)
            {
